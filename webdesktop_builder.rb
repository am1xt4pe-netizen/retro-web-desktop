...
post '/desktop/new' do
  ...
  default_items.each_with_index do |item, i|
    db.execute(
      ...
      [desktop_id, item[0], item[1], item[2], item[3], item[4], item[1] == 'Chord Lab' ? '/tools/chord_lab.html' : (item[1] == 'Guitar Library' ? '/tools/classical_guitar_library.html' : (item[1] == 'Scale Machine' ? '/tools/global_scales_visualizer.html' : (item[1] == 'Write v5' ? '/tools/write.html' : nil))), i]
    )
  end
